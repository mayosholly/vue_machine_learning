        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Gold Prediction with Extra Tree</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Machine Learning Gold Prediction using Extra Tree</h5>
...
export default {
    ...
    methods: {
        async submitForm() {
            ...
            try {
                this.isLoading = true;
                const response = await axios.post('/predict-gold-et', this.model.gold)
