        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Gold Prediction with Random Forest</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Machine Learning Gold Prediction using Random Forest</h5>
...
export default {
    ...
    methods: {
        async submitForm() {
            ...
            try {
                this.isLoading = true;
                const response = await axios.post('/predict-gold-rf', this.model.gold)
