        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Gold Prediction</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Machine Learning Gold Prediction</h5>
                                ...
                                <form class="row g-3" @submit.prevent="submitForm">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" v-model="model.gold.Volume" step="0.01" id="Volume" placeholder="Volume">
...
export default {
    ...
    methods: {
        async submitForm() {
            ...
            try {
                this.isLoading = true;
                const response = await axios.post('/predict-gold', this.model.gold)
